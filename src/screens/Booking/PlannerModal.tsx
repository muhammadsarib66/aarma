...
if(planner.description === "" || planner.estCost === "" || planner.deadline === ""){
      ...
      >
        <Box className=" w-[500px] flex flex-col gap-4" sx={style}>
          <div className="flex justify-between">
            ...
            <span> <i className="text-2xl fa-solid fa-times cursor-pointer" onClick={handleClose}></i> 
             </span>
          </div>
          <InputField value={planner.description} Name="description" onChange={handleChange} label="Plan Title" placeholder="Enter Plan Description" />
          <InputField type='number' value={planner.estCost} Name="estCost" onChange={handleChange} label="Plan Budget" placeholder="Enter Budget" />
          <InputField
          value={planner.deadline} Name="deadline" onChange={handleChange}
            type="date"
            label="Plan Deadline"
